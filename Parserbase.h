...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TypeOfBase<Tag__::ls>
    {
        typedef std::list<std::string>* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::str>
    {
    ...
    template <>
    struct TypeOfBase<Tag__::func>
    {
        typedef func_ast* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::op>
    {
        typedef int DataType;
    };

    template <>
    struct TypeOfBase<Tag__::btype>
    {
        typedef basicType DataType;
    };

    template <>
    struct TypeOfBase<Tag__::arr>
    {
        typedef arr_ast* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::expr>
    {
